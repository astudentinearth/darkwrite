export interface Note {
  ...
  /** The ID of the workspace this note belongs to. During migrations from v0.1-0.5x alphas, a default workspace should be created and the ID of that worksapce should be integrated. */
  workspaceId: string;
