...
export function EditorContentWrapper({ initialValue, onChange }: EditorProp){
    ...
    className={cn("p-0 rounded-xl w-full flex-grow dark break-words transition-transform", 
      (fontStyle == "sans" || fontStyle == null) && "darkwrite-sans", fontStyle == "serif" && "darkwrite-serif", fontStyle == "mono" && "darkwrite-mono", fontStyle == "custom" && "darkwrite-custom-font")}
