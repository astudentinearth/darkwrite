      ...
      >
        <TooltipProvider>
          ...
          <div className="h-full flex flex-col grow overflow-hidden">
            ...
            <div
              className={cn(
                "bg-view-1 h-full overflow-x-hidden scroll-smooth scroll-view transition-[margin] duration-150 border-border/25 ml-0 mb-1.5 mr-1.5 z-1 rounded-md rounded-br-sm border",
