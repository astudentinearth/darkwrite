...
export default function SlashCommand(){
    return <EditorCommand className="z-50 h-auto max-h-[40vh] overflow-y-auto rounded-xl border border-muted bg-background px-1 py-1 shadow-md transition-all drop-shadow-xl">
