...
function SearchBox(){
    ...
    return <div onClick={()=>{searchbox.current.focus();}} className="flex box-shadow-4-8-20 float-left items-center h-12 hover:bg-hover transition-all rounded-2xl bg-secondary">
        ...
        <input type="text" ref={searchbox} placeholder={GetLocalizedResource("searchBoxPlaceholder",locale)} className="pl-2 box-border bg-transparent ml-8 inline-block hide-outline search-box h-10 w-80 text-xl"></input>
    </div>
}
